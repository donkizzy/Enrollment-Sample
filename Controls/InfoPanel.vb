...
#End Region
        ...
        Private Sub PropertyGrid_Click(sender As Object, e As EventArgs) Handles MyBase.Click

        End Sub

        Private Sub propertyGrid_Click_1(sender As Object, e As EventArgs) Handles MyBase.Click
        ...
        End Sub
        Public Sub datas(ByVal _Sub_Agent_Number As String, ByVal _Agency_Number As String, ByVal _Sub_Agent_first_Name As String, ByVal _Sub_Agent_second_name As String, _Sub_Agent_Gender As String)
