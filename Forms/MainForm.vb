...
Namespace Forms
    Partial Public Class MainForm
        Inherits Form
        Dim _Dal As New DAL
        Dim Infopanels As New InfoPanel
        Dim _dataModels As New DataModel
        Dim _template As NTemplate
        Dim con As SqlConnection
        Dim SqlHelper As New SqlHelper
        Dim fingerData
        Dim buffer As NBuffer
        Dim a As String
...
#Region "Private form events"
        ...
        Private Sub BtnStartCapturingClick(ByVal sender As Object, ByVal e As EventArgs) Handles btnStartCapturing.Click
            ...
            _template = _model.Subject.GetTemplate()

            'Dim FIngerData As String = _template.ToString()

            buffer = _template.Save()
            fingerData = buffer.ToArray()
        ...
        Private Sub TsbSaveImageClick(ByVal sender As Object, ByVal e As EventArgs) Handles tsbSaveImage.Click
            Console.WriteLine("TsbSaveImageClick")
        ...
        Private Sub TsbSaveRecordClick(ByVal sender As Object, ByVal e As EventArgs) Handles tsbSaveRecord.Click
            Console.WriteLine("TsbSaveRecordClick")
            Dim finger As NFinger = CType(toolStripViewControls.Tag, NFinger)
        ...
        Private Sub SaveTemplateToolStripMenuItemClick(ByVal sender As Object, ByVal e As EventArgs) Handles saveTemplateToolStripMenuItem.Click
            Try
                ...
                Console.WriteLine("SaveTemplateToolStripMenuItemClick")
            ...
            Catch ex As Exception
                BLL.WriteLog(ex.Message + " " + ex.StackTrace + " " + ex.StackTrace)
                Throw ex
            End Try
        End Sub
        ...
        Private Sub SaveImagesToolStripMenuItemClick(ByVal sender As Object, ByVal e As EventArgs) Handles saveImagesToolStripMenuItem.Click
            Console.WriteLine("SaveImagesToolStripMenuItemClick")
            If _model.Subject IsNot Nothing Then
        ...
        Private Sub ExportToolStripMenuItemClick(ByVal sender As Object, ByVal e As EventArgs) Handles exportToolStripMenuItem.Click
            ...
            Try
                ...
                '    Utilities.ShowWarning("Nothing to save")
                'Else
                '    Using _templates As NTemplate = _model.Subject.GetTemplate()
                '        If _templates.Fingers Is Nothing Then

                '            Utilities.ShowWarning("Nothing to save")
                '            MsgBox("NOTHING TO SAVE")
                '        ElseIf saveFileDialog.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
                '            Using buffer As NBuffer = _templates.Save()
                '                File.WriteAllBytes(saveFileDialog.FileName, buffer.ToArray())
                '            End Using
                '        End If
                '    End Using
                ...
                Dim SUB_AGENT_NUMBER As String
                Dim TEMPLATE As String
                Dim SUB_AGENT_FIRST_NAME As String
                Dim SUB_AGENT_LAST_NAME As String
                Dim AGENCY_NUMBER As String
                Dim SUB_AGENT_GENDER As String
                Dim ACTION_TYPE As String


                SUB_AGENT_NUMBER = Terminal_number.Text
                TEMPLATE = fingerData
                SUB_AGENT_FIRST_NAME = sub_agent_first_names.Text
                SUB_AGENT_LAST_NAME = sub_agent_second_name.Text
                AGENCY_NUMBER = _agency_number.Text
                SUB_AGENT_GENDER = gender_dropdown.SelectedItem
                ACTION_TYPE = "INSERT"




                _Dal.FINGERPRINT_INSERT(SUB_AGENT_NUMBER, TEMPLATE, SUB_AGENT_FIRST_NAME, SUB_AGENT_LAST_NAME,
                    AGENCY_NUMBER, SUB_AGENT_GENDER, ACTION_TYPE)
...
#Region "Private methods"
        ...
        Private Function CreateBiometricClient() As NBiometricClient
            ...
            client.FingersTemplateSize = NTemplateSize.Small

            LongActionDialog.ShowDialog(Me, "Initializing biometric client ...", client.InitializeAsync().AsTask())
        ...
        Private Sub InitializeClient(ByVal sender As Object, ByVal args As Object)
            CType(args.Argument, NBiometricClient).InitializeAsync()
        End Sub
